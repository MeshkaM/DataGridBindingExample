...
namespace DataGridBindingExampleCore
{
    public partial class MainWindowViewModel : ObservableObject
    {
        ...
        public ObservableCollection<PlacesOfInterest> CurrentPlacesOfInterest
        {
            get => SelectedStudent.PlacesOfInterest;
        }
        ...
        private async void LoadDataAsync()
        {
            ...
            this.PlacesOfInterest = new ObservableCollection<PlacesOfInterest>(await DAL.LoadPlacesOfInterestAsync());
